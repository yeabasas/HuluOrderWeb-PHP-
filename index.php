...
<body>
    <div style="display: flex;flex-direction: column;flex-grow: 1;">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDarkDropdownMenuLink">
                                    <?php if (strlen($_SESSION['mtid'] > 0)) { ?>
                                        ...
                                        <li><a class="dropdown-item" <?php if ($current_page == 'post.php') echo 'class="active"'; ?> href="post.php">Post</a></li>
            ...
            <div style="width: 80%;">
                <div class="header-index">
                    <form action="" method="GET">
                        <input type="text" id="search-input" name="search" placeholder="Search by Name" style="padding-left: 30px;" oninput="showSuggestions(this.value)">
                        <button type="submit" class="search-btn">Search</button>
                    </form>
                </div>
                <div class="categories">
                    <a class="cat-icons" style="text-decoration: none;" href="?category=phone">
                        <div class="cat-icons-con">
                            <img src="./public/icons8-mobile-100.png" alt="" width="55px" height="55px" style="justify-self: center;margin:auto">
                        </div>
                        <p class="cat-icons-txt">Phones</p>
                    </a>
                    <a class="cat-icons" style="text-decoration: none;" href="?category=tablet">
                        <div class="cat-icons-con">
                            <img src="./public/icons8-tablet-100.png" alt="" width="55px" height="55px" style="justify-self: center;margin:auto">
                        </div>
                        <p class="cat-icons-txt">Tablet</p>
                    </a>
                    <a class="cat-icons" style="text-decoration: none;" href="?category=computer">
                        <div class="cat-icons-con">
                            <img src="./public/icons8-laptop-100.png" alt="" width="60px" height="60px" style="display:flex; justify-self: center;margin:auto">
                        </div>
                        <p class="cat-icons-txt">Computer</p>
                    </a>
                    <a class="cat-icons" style="text-decoration: none;" href="?category=electronics">
                        <div class="cat-icons-con">
                            <img src="./public/icons8-electronics-100.png" alt="" width="55px" height="55px" style="justify-self: center;margin:auto">
                        </div>
            ...
            <div class="grid-con-index">
                <div class="grid-wrapper-index">
                    ...
                    if (isset($_GET['search']) && !empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM posts WHERE ItemName LIKE '%$searchTerm%' && status !='Hidden'";
                    } elseif (isset($_GET['category'])) {
                        $category = mysqli_real_escape_string($con, $_GET['category']);
                        $sql = "SELECT * FROM posts WHERE Category = '$category' && status !='Hidden'";
                    } else {
                        $sql = "SELECT * FROM posts WHERE status !='Hidden'";
                    }
                            ...
                            <a href="postDetail.php?id=<?php echo $fetch['ID'] ?>&uId=<?php echo $fetch['userId'] ?>" id="updateLink">
                                <div class="posts-img">
                                    ...
                                    if ($rowImage = mysqli_fetch_assoc($resultImages)) {
                                        $imageFilename = $rowImage['image_filename'];
                                        echo '
                                    <img src="imageUpload.php?filename=' . $imageFilename . '" alt="" height="100%" width="100%" style="border-radius:10px 10px 0 0">
                                    ';
                                    }
                                    mysqli_stmt_close($stmtImages);
                                    ?>
                                ...
                                <div class="posts-txt-btm">
                                    ...
                                    <div class="d-flex flex-row justify-content-between align-items-end">
                                        ...
                                        <!-- <p class="posts-txt-low"><?php echo $fetch['Verified'] ?></p> -->
                                    </div>
                                </div>
                            </a>
                        </div>
        ...
        <footer class="" style="background: #394E42;color: white;padding: 10px;text-align: center;">
            ...
            <a href="https://www.tiktok.com/@huluorder" target="_blank" class="text-decoration-none">
            ...
            <a href="https://t.me/Hulu_Order" target="_blank" class="text-decoration-none">
                <svg fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
                ...
                success: function(data) {
                    ...
                    if (suggestions.length > 0) {
                        suggestions.forEach(function(suggestion) {
                            ...
                            suggestionItem.innerHTML = suggestion.ItemName;
                            suggestionItem.onclick = function() {
                                document.getElementById("search-input").value = suggestion.ItemName;
