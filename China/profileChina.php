...
<body>
    ...
    <div class="m-auto w-50 h-100 mt-5">
        <form method="post" name='signup' action="" class="shadow bg-body-tertiary rounded mb-5 mt-5">
            <?php
            $uid = $_SESSION['mtid'];
            ...
            ?>
                <div class="p-5">
                    <h3 class="mx-auto text-center">Change Profile</h3>
                    ...
                    <div style="padding-top: 30px;">
                        ...
                        <input type="text" class="form-control mb-3" name="Phone" value="<?php echo $row['Phone']; ?>" readonly>
                    </div>
                <?php } ?>
