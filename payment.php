...
if (isset($_POST['suggest'])) {
    ...
    $query = "update stoke set UserID='$uid',ScreenImage='$filename',status='$stat' where sID='$sid'";
    ...
    <div class="asdf">
        ...
        <div>
            <a href="" data-toggle="modal" data-target="#forNo">
                <div class="payer">
                    <img src="./images/untitled2-1@2x.png" alt="">
                </div>
            </a>
        </div>
        <div>
                ...
                ?>
                    ...
                    <form method="post" action="" class="form-control" enctype="multipart/form-data">
                        <div class="modal-body">
                            <p class="mb-3 text-center">Please pay and send the Screenshot below</p>
                            <p class="text-center">the Price You are paying is <strong style="font-size: larger;"> <?php echo $fetch['Price'] ?></strong> birr</p>
                            ...
                            <input class="form-control mb-3" type="file" name="choosefile" id="" required>
